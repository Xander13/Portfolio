...
function resetScroll() {
  // Check if we are on alex-kauffman.com without any path or query parameters
  if (window.location.hostname === 'alex-kauffman.com' && window.location.pathname === '/' && window.location.search === '') {
    window.scrollTo(0, 0);
  }
}
